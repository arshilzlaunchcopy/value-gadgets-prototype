...
(async () => {
  ...
  else if (args.includes("--content")) out = { content: await seed.seedContent(), landing: await seed.seedLandingPages(), pages: await seed.seedPages(), admin: await seed.seedAdmin() };
