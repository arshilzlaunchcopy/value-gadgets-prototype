// Generated by scripts/gen-types.ts on 2026-09-12T19:03:09.516Z - do not edit by hand.
...
export type Database = {
  ...
  public: {
    ...
    Views: {
      ...
      products_public: {
        Row: {
          ...
          primary_image_manifest: Json | null
    ...
    Functions: {
      ...
      increment_coupon_usage: { Args: { p_coupon: string }; Returns: number }
      increment_customer_orders: {
        Args: { p_customer: string }
        Returns: number
      }
      increment_landing_view: {
        Args: { p_id: string; p_variant: string }
        Returns: undefined
      }
      ...
      release_cart_reservations: { Args: { p_cart: string }; Returns: number }
      ...
      reserved_qty: {
        Args: { p_exclude_cart?: string; p_variant: string }
        Returns: number
      }
    }
    Enums: {
